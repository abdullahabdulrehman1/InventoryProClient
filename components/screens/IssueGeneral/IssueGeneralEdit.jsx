    ...
    const validationRules = [
      ...
      },
      {
        ...
        validations: [
          {
            method: validationMethods.required,
            message: 'Issue To Unit is required'
          }
        ]
      },
      {
      ...
      },
      {
        ...
        validations: [
          {
            method: validationMethods.required,
            message: 'Issue To Department is required'
          }
        ]
      },
      {
      ...
      },
      {
        field: 'driver',
        validations: [
          { method: validationMethods.required, message: 'Driver is required' }
        ]
      },
      {
        field: 'remarks',
      ...
      },
      {
        ...
        validations: {
          ...
          previousIssueQty: [
            {
              method: validationMethods.required,
              message: 'Previous Issue Qty is required'
            },
            {
              method: validationMethods.isNumber,
              message: 'Previous Issue Qty must be a number'
            }
          ],
          balanceQty: [
            {
              method: validationMethods.required,
              message: 'Balance Qty is required'
            },
            {
              method: validationMethods.isNumber,
              message: 'Balance Qty must be a number'
            }
          ],
          issueQty: [
            {
            ...
            {
              method: validationMethods.isNumber,
              message: 'Issue Qty must be a number'
            }
          ],
          rowRemarks: [
            {
    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <FormRows
        ...
        rowFields={[
          ...
          {
            name: 'previousIssueQty',
            label: 'Previous Issue Qty',
